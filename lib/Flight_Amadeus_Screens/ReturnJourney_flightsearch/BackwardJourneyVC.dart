      ...
      final response = await http.post(
        ...
        body: jsonEncode(<String, dynamic>{
          ...
          "originDestinations": [
            // {
            //   "id": "1",
            //   "originLocationCode": Retrived_Rndorigin_iatacodestr,
            //   "destinationLocationCode": Retrived_Rndtrp_Destinationiatacodestr,
            //   "departureDateTimeRange": {
            //     "date": "2024-09-12"
            //   }
            // },
            {
              "id": "2",
              "originLocationCode": Retrived_Rndtrp_Destinationiatacodestr,
              "destinationLocationCode": Retrived_Rndorigin_iatacodestr,
              "departureDateTimeRange": {
                "date": "2024-09-12"
              }
            },
